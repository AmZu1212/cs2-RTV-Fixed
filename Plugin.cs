...
namespace cs2_rockthevote
{
    ...
    public partial class Plugin : BasePlugin, IPluginConfig<Config>
    {
        ...
        public override string ModuleAuthor => "AmZu The Goat";
        public override string ModuleDescription => "https://github.com/AmZu1212";
        ...
        {
            var playerUID = @event.Userid;
            var player = Utilities.GetPlayerFromUserid(playerUID);
